 ...
 * @returns void
 */
export const mongoGet = async (collectionName, query) => {
 ...
 */
export const mongoPost = async (collectionName, mongoDocuments = []) => {
...
export const mongoDelete = async (collectionName, filter) => {
...
export const mongoUpsert = async (collectionName, query, upsertObject) => {
