import { googleApisScopes, loggingContext } from '../../constants/index.js'
import {
  getAuthClient,
  getUserAuthUrl,
  validateUserSession,
...
async function authCallbackGet(req, res) {
  ...
  try {
    ...
    const oauth2ClientAccessTokenRespose = await oauth2Client.getToken(authCode)
...
export { authCallbackGet, authGet, authMeGet }
