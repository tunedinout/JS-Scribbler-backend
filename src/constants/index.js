export const loggingContext = {
  ...
  apis: {
    ...
    // cachePostScribble: '/api/v1/sync - POST',
    // cachePutScribble: '/api/v1/sync/:id - PUT',
    // cacheGetScribble: '/api/v1/sync/:id - GET',
    // cacheGetScribbles: 'api/v1/sync - GET',
    // cachePostScribbles: '/api/v1/sync - POST',
  },
  redisUtils: {
    // self: 'redis.js',
    // postScribble: 'postScribble',
    // putScribble: 'putScribble',
    // getScribble: 'getScribble',
    // getAllScribbles: 'getAllScribbles',
    // exists: 'exists',
  },
  workers: {
    self: 'workers',
    ensureScribbleFolder: 'ensureScribbleFolder',
    flushScribbleToDrive: 'flushScribbleToDrive',
    backFillIfEmpty: 'backFillIfEmpty',
    runWriter: 'runWriter',
  },
}
...
export const enabledLoggingContexts = [
  ...
  ...Object.values(loggingContext.redisUtils),
]
